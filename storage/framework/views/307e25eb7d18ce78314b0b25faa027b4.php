            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted small mb-3"><?php echo e('@'.$user->username); ?></p>
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('my-modules')); ?>" class="btn btn-sm btn-outline-primary">
                            <i class="bi bi-grid-3x3-gap"></i> Manage Modules
                        </a>
                    </div>
                    <div class="card-body">
                        <?php if($joinedModules->isEmpty()): ?>
                            <p class="text-muted mb-0">
                                You haven't joined any modules yet.
                                <a href="<?php echo e(route('my-modules')); ?>">Browse what's available</a>.
                            </p>
                        <?php else: ?>
                            <div class="row g-3">
                                <?php $__currentLoopData = $joinedModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center justify-content-between border rounded p-2">
                                            ...
                                            <?php if($module->route): ?>
                                                <a href="<?php echo e(route($module->route)); ?>" class="btn btn-sm btn-outline-secondary">Open</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($availableModulesCount > 0): ?>
                                <p class="text-muted small mt-3 mb-0">
                                    <?php echo e($availableModulesCount); ?> more module<?php echo e($availableModulesCount === 1 ? '' : 's'); ?> available to join —
                                    <a href="<?php echo e(route('my-modules')); ?>">add another one</a>.
                                </p>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
