    ...
    <header class="site-header">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-sm">Submit a Manuscript</a>
            </div>
        </div>
    </header>

    <div class="container hero">
        <form method="GET" action="<?php echo e(route('journal.public.index')); ?>" class="search-box mb-4">
