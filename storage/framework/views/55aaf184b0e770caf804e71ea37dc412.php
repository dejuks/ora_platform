...
<?php $component->withAttributes([]); ?>
  ...
  <div class="main-content page-library-pricing-plan-create">
    ...
    <form action="<?php echo e(route('library.pricing-plans.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
        ...
        <div class="card-body row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="number" step="0.01" name="amount" class="form-control"
                   value="<?php echo e(old('amount')); ?>" min="0" max="100000" required>
          </div>

          <div class="col-md-4">
            <label class="form-label">Currency *</label>
            <input type="text" name="currency" class="form-control" value="<?php echo e(old('currency', 'ETB')); ?>" maxlength="8" required>
          </div>
      ...
      <div class="d-flex gap-2">
        ...
        <a href="<?php echo e(route('library.pricing-plans.index')); ?>" class="btn btn-outline-secondary">Cancel</a>
      </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Dejene\Desktop\project\ora\resources\views/modules/library/pricing-plans/create.blade.php ENDPATH**/ ?>