...
<?php $component->withAttributes([]); ?>
  ...
  <div class="main-content d-flex flex-column align-items-center justify-content-center text-center" style="min-height:60vh;">
    ...
    <h1 class="h3 mt-3"><?php echo e($moduleLabel); ?> — Module Admin</h1>
    <p class="text-muted">You administer this module. Its admin tools are the next thing to build.</p>

    <a href="<?php echo e(route('journal.settings.edit')); ?>" class="btn btn-outline-secondary mt-2">
...
<?php endif; ?>
<?php /**PATH C:\Users\Dejene\Desktop\project\ora\resources\views/modules/journal/admin-dashboard.blade.php ENDPATH**/ ?>