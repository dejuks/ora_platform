...
<?php $component->withAttributes([]); ?>
  ...
  <div class="main-content page-ebook-settings">
    ...
    <form action="<?php echo e(route('ebook.settings.update')); ?>" method="POST">
      <?php echo csrf_field(); ?>
        ...
        <div class="card-body row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="number" step="0.01" name="processing_fee" class="form-control"
                   value="<?php echo e(old('processing_fee', $settings->processing_fee)); ?>" min="0" max="100000" required>
          </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Dejene\Desktop\project\ora\resources\views/modules/ebook/settings/edit.blade.php ENDPATH**/ ?>