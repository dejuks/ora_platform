...
<div class="topbar">
    <a class="brand" href="<?php echo e(route('researcher.register')); ?>">
        <span class="brand-mark">ኦ</span>
...
<div class="stage">
    ...
    <div class="hero">
        ...
        <svg class="network" viewBox="0 0 600 700" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
            <g stroke="#c98a2c" stroke-opacity="0.35" stroke-width="1">
    ...
    <div class="form-panel">
        <div class="form-wrap">
            ...
            <form method="POST" action="<?php echo e(route('researcher.register.post')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Dejene\Desktop\project\ora\resources\views/modules/researcher/public/register.blade.php ENDPATH**/ ?>