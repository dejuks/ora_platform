            ...
            <div class="card-body">
              ...
              @else
                <p class="mb-3">
                  ...
                  <strong>{{ config('journal.currency', 'ETB') }} {{ number_format($manuscript->publication_fee, 2) }}</strong>
            ...
            <div class="card-body">
              ...
              @else
                <p class="text-muted mb-0">
                  ...
                  ({{ config('journal.currency', 'ETB') }} {{ number_format($manuscript->publication_fee, 2) }})
