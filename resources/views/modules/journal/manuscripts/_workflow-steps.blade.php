{{--
    Horizontal progress stepper for the manuscript submission -> publishing
    pipeline. Expects $manuscript to be in scope.

    Usage: @include('modules.journal.manuscripts._workflow-steps')
--}}

@php $steps = $manuscript->workflowSteps(); @endphp
