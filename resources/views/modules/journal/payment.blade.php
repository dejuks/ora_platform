    ...
    <div class="main-content page-manuscript-payment">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">{{ $manuscript->title }}</p>
            </div>
            <a href="{{ route('journal.manuscripts.show', $manuscript) }}" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-6">
                ...
                {{ \App\Models\JournalSetting::current()->currency }} {{ number_format($manuscript->publication_fee, 2) }}
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4 px-3 py-2 border rounded">
                            ...
                            <span class="fw-semibold">{{ $manuscript->author->email }}</span>
                        </div>

                        <form action="{{ route('journal.manuscripts.pay.process', $manuscript) }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3" id="cardholderField">
                                ...
                                <input type="text" name="cardholder_name" class="form-control"
                                       ...
                                       value="{{ old('cardholder_name', $manuscript->author->full_name ?? '') }}">
                            </div>
                            ...
                            <p class="text-muted small">
                                ...
                                <strong>{{ $manuscript->author->email }}</strong>. We never see or store
                            ...
                            <button type="submit" class="btn btn-success w-100">
                                ...
                                Pay {{ \App\Models\JournalSetting::current()->currency }} {{ number_format($manuscript->publication_fee, 2) }} with Chapa
                            </button>
                        </form>
