<x-layout>
  ...
  <div class="main-content page-journal-category-create">

    <div class="mb-4">
      <h1 class="h3 mb-1">New Category</h1>
      <p class="text-muted mb-0">Add a category Authors can tag manuscripts with.</p>
    </div>
    ...
    <form action="{{ route('journal.categories.store') }}" method="POST">
      ...
      <div class="d-flex gap-2">
        ...
        <a href="{{ route('journal.categories.index') }}" class="btn btn-outline-secondary">Cancel</a>
      </div>
